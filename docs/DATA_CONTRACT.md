...
CSV with columns including `user_id` (`U01` … `U10` in the Zenodo deposit; legacy `UX_U01` … also accepted), `sus_score` (0–100), demographics as coded integers (see API `ux_uv_data.py` mappings).
